...
source "tart-cli" "tart" {
  vm_base_name = "ghcr.io/Goller-Networks/macos-${var.macos_version}-vanilla:latest"
...
build {
  ...
  // Create a /Users/runner → /Users/sean symlink to support certain GitHub Actions
  ...
  provisioner "shell" {
    inline = [
      "sudo ln -s /Users/sean /Users/runner"
    ]
  }
